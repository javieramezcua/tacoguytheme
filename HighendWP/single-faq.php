...
<div id="main-content">
	...
	<?php if ( have_posts() ) : while ( have_posts() ) : the_post(); ?>
		...
		<?php } ?>
			...
			<div class="single-blog-wrapper clearfix" itemprop="mainContentOfPage" itemscope="itemscope" itemtype="https://schema.org/Blog">
				<!-- BEGIN .hentry -->
				<article id="post-<?php the_ID(); ?>" <?php post_class( get_post_format() . '-post-format single' ); ?> itemscope="itemscope" itemtype="https://schema.org/BlogPosting" itemprop="blogPost">
					<?php 
					if ( hb_options('hb_blog_enable_featured_image') )
