<div class="wrap">
	...
	<div id="vp-wrap" class="vp-wrap">
			...
			<div class="vp-right-panel">
				<form id="vp-option-form" class="vp-option-form vp-js-option-form" method="POST">
					<div id="vp-submit-top" class="vp-submit top">
						<div class="inner">
							<a href="https://www.anrdoezrs.net/links/8353661/type/dlg/http://www.mojomarketplace.com/item/wordpress-support" target="_blank" class="hb-expert-help">Need help? Get professional WordPress support & training!</a>
							<input class="vp-save vp-button button button-primary" type="submit" value="<?php _e('Save Changes', 'hbthemes'); ?>" />
							<p class="vp-js-save-loader save-loader" style="display: none;"><img src="<?php VP_Util_Res::img_out('ajax-loader.gif', ''); ?>" /><?php _e('Saving Now', 'hbthemes'); ?></p>
		...
		<div id="vp-copyright" class="vp-copyright">
			<p><?php printf(__('This option panel is built using <a href="http://vafpress.com/vafpress-framework">Vafpress Framework %s</a> powered by <a href="http://vafpress.com">Vafpress</a>', 'hbthemes'), VP_VERSION); ?></p>
		</div>
