...
<form action="/" method="get" accept-charset="utf-8">
		...
		<div class="form-section clearfix">
            <label for="icon-name">Icon Name.<br/><small>Enter a name of icon you would like to use. You can find list of icons here: <a href="https://documentation.hb-themes.com/icons/" target="_blank">Icon List</a><br/>Example: hb-moon-apple-fruit</small></label>
