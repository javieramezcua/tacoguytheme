...
<?php if ( class_exists( 'SocialSnap' ) ) {
	return;
} ?>
...
<div class="share-holder"><i class="hb-moon-share-2"></i><?php _e('Share','hbthemes'); ?>
	...
	<div class="hb-dropdown-box share-dropdown-box">
		<ul class="blog-social-share">
			...
			<li><a class="pinterest-share" onclick="popWindow('http://pinterest.com/pin/create/button/?url=<?php the_permalink(); ?>&amp;media=<?php echo $feat_image; ?>&amp;description=<?php echo get_bloginfo('title') . ' - '; the_title(); ?>','Pinterest','500','400')" title="Pinterest" rel="tooltip" data-placement="right"><i class="hb-moon-pinterest"></i></a></li>
			<?php } ?>
