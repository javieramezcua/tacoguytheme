...
class hb_gmap_widget extends WP_Widget {
	...
	function __construct() {
		...
		parent::__construct( 'gmap','[HB-Themes] Google Maps', $widget_ops );
	}
	...
	function widget( $args, $instance ) {
		...
		$api_key = hb_options('hb_gmap_api_key');
...
?>
		...
		<?php } ?>
			...
			jQuery(window).load(function($) {
				google.load("maps", "3", {other_params:'key=<?php echo $api_key;?>', callback: function(){
	  				var map;
