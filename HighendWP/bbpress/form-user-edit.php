...
<form id="bbp-your-profile" action="<?php bbp_user_profile_edit_url( bbp_get_displayed_user_id() ); ?>" method="post">
	...
	<h2 class="entry-title"><?php _e( 'Name', 'hbthemes' ) ?></h2>

	<?php do_action( 'bbp_user_edit_before' ); ?>

	<fieldset class="bbp-form">
		<legend><?php _e( 'Name', 'hbthemes' ) ?></legend>

		<?php do_action( 'bbp_user_edit_before_name' ); ?>

		<div>
			<label for="first_name"><?php _e( 'First Name', 'hbthemes' ) ?></label>
		...
		<div>
			<label for="last_name"><?php _e( 'Last Name', 'hbthemes' ) ?></label>
		...
		<div>
			<label for="nickname"><?php _e( 'Nickname', 'hbthemes' ); ?></label>
		...
		<div>
			<label for="display_name"><?php _e( 'Display name publicly as', 'hbthemes' ) ?></label>
	...
	<h2 class="entry-title"><?php _e( 'Contact Info', 'hbthemes' ) ?></h2>

	<fieldset class="bbp-form">
		<legend><?php _e( 'Contact Info', 'hbthemes' ) ?></legend>
	...
	<h2 class="entry-title"><?php bbp_is_user_home_edit() ? _e( 'About Yourself', 'hbthemes' ) : _e( 'About the user', 'hbthemes' ); ?></h2>

	<fieldset class="bbp-form">
		<legend><?php bbp_is_user_home_edit() ? _e( 'About Yourself', 'hbthemes' ) : _e( 'About the user', 'hbthemes' ); ?></legend>

		<?php do_action( 'bbp_user_edit_before_about' ); ?>

		<div>
			<label for="description"><?php _e( 'Biographical Info', 'hbthemes' ); ?></label>
			...
			<span class="description"><?php _e( 'Share a little biographical information to fill out your profile. This may be shown publicly.', 'hbthemes' ); ?></span>
		</div>
	...
	<h2 class="entry-title"><?php _e( 'Account', 'hbthemes' ) ?></h2>

	<fieldset class="bbp-form">
		<legend><?php _e( 'Account', 'hbthemes' ) ?></legend>

		<?php do_action( 'bbp_user_edit_before_account' ); ?>

		<div>
			<label for="user_login"><?php _e( 'Username', 'hbthemes' ); ?></label>
			...
			<span class="description"><?php _e( 'Usernames cannot be changed.', 'hbthemes' ); ?></span>
		</div>

		<div>
			<label for="email"><?php _e( 'Email', 'hbthemes' ); ?></label>
			...
			if ( $new_email && $new_email != bbp_get_displayed_user_field( 'user_email' ) ) : ?>
				...
				<span class="updated inline">
					...
					<?php printf( __( 'There is a pending email address change to <code>%1$s</code>. <a href="%2$s">Cancel</a>', 'hbthemes' ), $new_email['newemail'], esc_url( self_admin_url( 'user.php?dismiss=' . bbp_get_current_user_id()  . '_new_email' ) ) ); ?>
		...
		<div id="password">
			<label for="pass1"><?php _e( 'New Password', 'hbthemes' ); ?></label>
			<fieldset class="bbp-form">
				<input type="password" name="pass1" id="pass1" size="16" value="" autocomplete="off" tabindex="<?php bbp_tab_index(); ?>" />
				<span class="description"><?php _e( 'If you would like to change the password type a new one. Otherwise leave this blank.', 'hbthemes' ); ?></span>

				<input type="password" name="pass2" id="pass2" size="16" value="" autocomplete="off" tabindex="<?php bbp_tab_index(); ?>" />
				<span class="description"><?php _e( 'Type your new password again.', 'hbthemes' ); ?></span><br />

				<div id="pass-strength-result"></div>
				<span class="description indicator-hint"><?php _e( 'Hint: The password should be at least seven characters long. To make it stronger, use upper and lower case letters, numbers and symbols like ! " ? $ % ^ &amp; ).', 'hbthemes' ); ?></span>
			</fieldset>
		</div>
		...
		<?php if ( current_user_can( 'edit_users' ) && ! bbp_is_user_home_edit() ) : ?>
			...
			<div>
				<label for="role"><?php _e( 'Role:', 'hbthemes' ) ?></label>
		...
		<?php if ( is_multisite() && is_super_admin() && current_user_can( 'manage_network_options' ) ) : ?>
			...
			<div>
				<label for="role"><?php _e( 'Super Admin', 'hbthemes' ); ?></label>
				<label>
					...
					<?php _e( 'Grant this user super admin privileges for the Network.', 'hbthemes' ); ?>
				</label>
			</div>
	...
	<fieldset class="submit">
		<legend><?php _e( 'Save Changes', 'hbthemes' ); ?></legend>
		<div>

			<?php bbp_edit_user_form_fields(); ?>

			<button type="submit" tabindex="<?php bbp_tab_index(); ?>" id="bbp_user_edit_submit" name="bbp_user_edit_submit" class="mk-button three-dimension mk-skin-button medium submit user-submit"><?php bbp_is_user_home_edit() ? _e( 'Update Profile', 'hbthemes' ) : _e( 'Update User', 'hbthemes' ); ?></button>
		</div>
	</fieldset>
