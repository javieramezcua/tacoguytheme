...
<form method="post" action="<?php bbp_wp_login_action( array( 'context' => 'login_post' ) ); ?>" class="bbp-login-form">
	<fieldset class="bbp-form">
		<legend><?php _e( 'Log In', 'hbthemes' ); ?></legend>
		...
		<div class="bbp-password">
			<label for="user_pass"><?php _e( 'Password', 'hbthemes' ); ?>: </label>
		...
		<div class="bbp-remember-me">
			...
			<label for="rememberme"><?php _e( 'Keep me signed in', 'hbthemes' ); ?></label>
		</div>
		...
		<div class="bbp-submit-wrapper">
			...
			<button type="submit" tabindex="<?php bbp_tab_index(); ?>" name="user-submit" class="mk-button three-dimension mk-skin-button medium submit user-submit"><?php _e( 'Log In', 'hbthemes' ); ?></button>
