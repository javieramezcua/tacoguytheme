...
<form action="/" method="get" accept-charset="utf-8">
		...
		<div id="social-icons-wrap">
	        ...
	        <div class="form-section clearfix">
	            <label for="twitter">Twitter URL.<br/><small>Enter your Twitter URL with https:// prefix. Leave empty to ignore.</small></label>
	            <input type="text" name="twitter" id="twitter" placeholder="Example: http://twitter.com/hbthemes"></textarea>
	        </div>

	        <div class="form-section clearfix">
	            <label for="facebook">Facebook URL.<br/><small>Enter your facebook URL with https:// prefix. Leave empty to ignore.</small></label>
	        ...
	        <div class="form-section clearfix">
	            <label for="behance">Behance URL.<br/><small>Enter your Behance URL with https:// prefix. Leave empty to ignore.</small></label>
