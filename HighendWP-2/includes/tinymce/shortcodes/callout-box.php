...
<form action="/" method="get" accept-charset="utf-8">
        ...
        <div class="form-section clearfix">
            <label for="button-link">Button Link URL.<br/><small>Choose URL of the link for the button. Enter with https:// prefix. You can also enter section id with # prefix to scroll to the section within your page. Example #home</small></label>
            <input type="text" name="button-link" id="button-link" placeholder="Example: https://hb-themes.com"></textarea>
        </div>
        ...
        <div class="form-section clearfix">
            <label for="icon-name">Icon Name.<br/><small>Enter a name of icon you would like to use. Leave empty if you don't want an icon. You can find list of icons here: <a href="https://documentation.hb-themes.com/icons/" target="_blank">Icon List</a><br/>Example: hb-moon-apple-fruit</small></label>
