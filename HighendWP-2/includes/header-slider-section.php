...
if ( highend_is_page_template( 'presentation-fullwidth' ) || is_search() ){
	return;
}
...
<div id="slider-section" class="clearfix<?php echo $fi_custom_class; echo $fi_parallax ?>" style="<?php if ( $fi_size=='custom-height' || $fi_size == 'window-height') echo 'height: ' . $fi_custom_size . 'px; background-image: url('.$full_image[0].'); background-size:cover; background-position: center center; background-repeat: no-repeat;';?>">
	<?php 
