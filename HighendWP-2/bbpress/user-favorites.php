...
?>
	...
	<div id="bbp-author-favorites" class="bbp-author-favorites">
		<h2 class="entry-title"><?php _e( 'Favorite Forum Topics', 'hbthemes' ); ?></h2>
		<div class="bbp-user-section">
			...
			<?php else : ?>
				...
				<p><?php bbp_is_user_home() ? _e( 'You currently have no favorite topics.', 'hbthemes' ) : _e( 'This user has no favorite topics.', 'hbthemes' ); ?></p>
