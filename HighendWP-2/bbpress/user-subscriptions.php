	...
	<?php if ( bbp_is_subscriptions_active() ) : ?>
		...
		<?php if ( bbp_is_user_home() || current_user_can( 'edit_users' ) ) : ?>
			...
			<div id="bbp-author-subscriptions" class="bbp-author-subscriptions">
				<h2 class="entry-title"><?php _e( 'Subscribed Forum Topics', 'hbthemes' ); ?></h2>
				<div class="bbp-user-section">
					...
					<?php else : ?>
						...
						<p><?php bbp_is_user_home() ? _e( 'You are not currently subscribed to any topics.', 'hbthemes' ) : _e( 'This user is not currently subscribed to any topics.', 'hbthemes' ); ?></p>
