...
return array(
        ...
        array(
          ...
          'description' => __('Upload an image to display behind the blog posts. ', 'hbthemes'),
          'default' => '',
        ),
        ...
        'label' => __('Select Categories', 'hbthemes'),
        'description' => __('Specify which categories will be displayed in this blog page.', 'hbthemes'),
        'items' => $hb_categories,
		    ),
